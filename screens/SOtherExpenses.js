...
const SOtherExpenses = ({ navigation, route }) => {
  ...
  const handleNextPress = () => {
    if (expensesList.length === 0) {
      ...
      navigation.navigate('SConfirmMeeting', { 
        meetingName,
        startTime,
        endTime,
        location,
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.bottomContainer}>
        ...
        <View style={styles.buttonContainer}>
          <Button title="Next" onPress={handleNextPress}  color="#710808" style={styles.skipIcon}/>
